...
<form:form modelAttribute="servantAttribute" method="POST" action="${saveUrl}">
    <table>
        ...
        <tr>
            <td><form:label path="educationByEducationId.educationId">Servant's education level:</form:label></td>
            <td><form:input path="educationByEducationId.educationId"/></td>
        </tr>
        <tr>
            <td><form:label path="jobByJobId.jobId">Servant's position:</form:label></td>
